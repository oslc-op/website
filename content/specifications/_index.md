...
| [Configuration Management 1.0 PS 01](https://docs.oasis-open-projects.org/oslc-op/config/v1.0/ps01/oslc-config-mgt.html) | **OSLC Open Project** | OSLC Configuration Management defines an RDF vocabulary and a set of REST APIs for managing versions and configurations of linked data resources from multiple domains. |
